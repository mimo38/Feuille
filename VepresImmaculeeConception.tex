...
\ligne{2}{10}
\subsection{aux premières vêpres}
\cantus{Antienne}{BeatamMeDicent}{Ant.}{8}
\canticum[tonus=8,primus=1,numerus=1]{Magnificat}
\gloria[tonus=8]

\ligne{2}{10}

\subsection{aux deuxièmes vêpres}
\cantus{Antienne}{HodieEgressaEst}{Ant.}{1}
\psalmus[numerus=1]{147-3a2}
\canticum[tonus=1,primus=1,numerus=1]{Magnificat}
\gloria[tonus=1]
