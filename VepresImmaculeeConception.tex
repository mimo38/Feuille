                    ...
                    \newcounter{facteur}\setcounter{facteur}{15}%%%%%%%%%%%%%% Paramètre pour la taille globale des partitions. par défaut : 17
                    %\usepackage{geometry}
...
%\vspace*{\stretch{1}}
%\newpage
\section{Vêpres de l'Immaculée Conception — 8 décembre}
\cantus{Verset}{DeusInAdiutorium_solemnis}{}{1}
\medskip
